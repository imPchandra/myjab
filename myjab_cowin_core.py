...
class Core:
    """This Class will contain a collection of method that interact directly with Cowin API and return A Requests
    Response Object. This class will give the user more fine grained access to the Cowin API. For more information
    on the Requests library visit: http://docs.python-requests.org/en/master/"""

    def __init__(self, host_name, user_credentials=None, api_version='v2/', oauth=False):
        #Class variables
